	...
	.WORD 0
	.WORD 0
	.INSERT ".\vehicledemogame_freq"
	.INSERT ".\vehicledemogame_data"
...
?L3:	FSET? PRSO,CONTBIT /?L4
	CALL2 NOT-POSSIBLE,STR?3 >STACK
	RSTACK
...
?L6:	PRINTI "You switch off "
	...
	ICALL2 POINTLESS,STR?16
	RTRUE
?L3:	ICALL2 NOT-POSSIBLE,STR?15
	RTRUE
...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?22 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 NOT-POSSIBLE,STR?28 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?29 >STACK
	RSTACK
...
?L1:	CRLF
	...
	.FUNCT V-MOUNT
	CALL1 V-MOUNT-F >STACK
	RSTACK

	.FUNCT V-DISMOUNT
	CALL1 V-DISMOUNT-F >STACK
	RSTACK

	.FUNCT V-ENTER
	FSET? PRSO,VEHBIT \FALSE
	CALL PERFORM,V?MOUNT,PRSO >STACK
	RSTACK

	.FUNCT V-MOUNT-F
	FSET? PRSO,VEHBIT /?L1
	ICALL2 PRINT-DEF,PRSO
	PRINTR " can't be ridden."
?L1:	EQUAL? PRSO,VEHICLE-LOC \?L3
...
?L5:	MOVE PLAYER,PRSO
	...
	.FUNCT V-DISMOUNT-F
	IN? PLAYER,VEHICLE-LOC /?L1
	PRINTR "You're not riding anything."
?L1:	LOC VEHICLE-LOC >STACK
	MOVE PLAYER,STACK
	PRINTI "You dismount from "
	ICALL2 PRINT-DEF,VEHICLE-LOC
	PRINTI "."
	CRLF
	SET 'VEHICLE-LOC,0
	CALL1 V-LOOK >STACK
	...
	IN? PLAYER,VEHICLE-LOC \FALSE
	PRINTI " (on "
	ICALL2 PRINT-DEF,VEHICLE-LOC
	PRINTI ")"
	RTRUE

	.FUNCT VEHICLE-SCOPE-CHECK
	FSET? VEHICLE-LOC,VEHBIT \FALSE
	FSET? VEHICLE-LOC,OPENBIT /FALSE
	PRINTI "You can't reach that from inside "
	ICALL2 PRINT-DEF,VEHICLE-LOC
	PRINTR "."
...
?L4:	CRLF
	...
	FSET? RM,TOUCHBIT \?L11
	EQUAL? MODE,VERBOSE /?L11
	GETP RM,P?ACTION >STACK
	ICALL2 STACK,M-FLASH
	RTRUE
?L11:	GETP RM,P?ACTION >STACK
	...
	PRINT P
	CRLF
?L16:	GETP RM,P?ACTION >STACK
	ICALL2 STACK,M-FLASH
	FSET RM,TOUCHBIT
	RTRUE

	.INSERT ".\vehicledemogame_str"
	.END
