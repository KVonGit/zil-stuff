...
?L73:	SET 'BITS,F
	SET 'OBITS,F
	JUMP ?L1
?L71:	EQUAL? NOUT,1 \?L76
	GET OUT,1 >STACK
	RSTACK
?L76:	EQUAL? MODE?1,MCM-ALL /?L78
	GRTR? NY,1 \?L77
?L78:	RETURN MANY-OBJECTS
?L77:	EQUAL? MODE?1,MCM-ANY \?L79
	RANDOM NOUT >STACK
	GET OUT,STACK >F
	PUT OUT,1,F
	PUTB OUT,0,1
	...
	CRLF
	RETURN F
?L79:	EQUAL? BITS,OBITS /?L81
	SET 'BITS,OBITS
	JUMP ?L1
?L81:	CALL2 APPLY-GENERIC-FCN,OUT >F
	ZERO? F /?L84
	PUT OUT,1,F
	PUTB OUT,0,1
	RETURN F
?L84:	ICALL2 WHICH-DO-YOU-MEAN,OUT
	EQUAL? NP,P-NP-DOBJ \?L87
	SET 'P-O-REASON,32768
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
?L87:	SET 'P-O-REASON,40960
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
...
?L4:	EQUAL? PRSA,V?GIVE \FALSE
	...
	.FUNCT DUCK-TURD-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "A fowl bit of potty humour."
?L1:	EQUAL? PRSA,V?DROP \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
