...
?L3:	PRINTI " "
	...
	PRINTI " "
	ICALL LIST-OBJECTS,OBJ,VISIBLE-FILTER?,L-ISARE
	PRINTI "."
	CRLF
	...
	FSET? OBJ,OMITCONTENTS /FALSE
	FSET? OBJ,SURFACEBIT \?L4
	PRINTI " (holding "
	JUMP ?L6
?L4:	PRINTI " (containing "
?L6:	FIRST? OBJ >F /?L8
	PRINTI "nothing)"
	RTRUE
?L8:	FIRST? OBJ >I \?L13
...
?L14:	EQUAL? N,2 \?L16
	...
	PRINTI " and "
	NEXT? F >STACK /?L17
?L17:	ICALL2 PRINT-INDEF,STACK
	JUMP ?L21
?L16:	FIRST? OBJ >I \?L21
?L19:	ICALL2 PRINT-INDEF,I
	DEC 'N
	ZERO? N /?L25
	EQUAL? N,1 \?L24
	PRINTI ", and "
...
?L3:	FSET? PRSO,CONTBIT /?L4
	CALL2 NOT-POSSIBLE,STR?10 >STACK
	RSTACK
...
?L1:	FSET? OBJ,PERSONBIT \?L9
	...
	ICALL1 YOU-MASHER
	RFALSE
?L9:	FSET? PRSO,INTEGRALBIT \?L12
	ICALL1 PART-OF
	RTRUE
?L12:	FSET? OBJ,TAKEBIT /?L13
	ZERO? SILENT \FALSE
	ICALL2 NOT-POSSIBLE,STR?13
	RFALSE
?L13:	IN? OBJ,WINNER \?L16
	ZERO? SILENT \FALSE
	PRINTI "You already have that."
	CRLF
	RFALSE
?L16:	CALL TAKE-HOLDER,OBJ,WINNER >HOLDER
	ZERO? HOLDER /?L30
	FSET? HOLDER,PERSONBIT \?L22
	ZERO? SILENT \FALSE
	...
	CRLF
	RFALSE
?L22:	CALL2 BLOCKS-TAKE?,HOLDER >STACK
	ZERO? STACK /?L26
	...
	CRLF
	RFALSE
?L26:	CALL TAKE-CAPACITY-CHECK,OBJ,SILENT >STACK
	ZERO? STACK /?L30
	FSET? HOLDER,CONTBIT \?L30
	...
	MOVE OBJ,WINNER
	ZERO? SILENT \TRUE
	EQUAL? REPORT-MODE,SHORT-REPORT \?L33
	PRINTR "Taken."
?L33:	PRINTI "You reach "
	CALL HELD?,WINNER,HOLDER >STACK
	ZERO? STACK /?L35
	PRINTI "out of "
	JUMP ?L37
?L35:	PRINTI "in "
?L37:	ICALL2 PRINT-DEF,HOLDER
	PRINTI " and take "
	ICALL2 PRINT-DEF,OBJ
	PRINTR "."
?L30:	CALL TAKE-CAPACITY-CHECK,OBJ,SILENT >STACK
	ZERO? STACK /FALSE
	FSET OBJ,TOUCHBIT
	MOVE OBJ,WINNER
	ZERO? SILENT \TRUE
	EQUAL? REPORT-MODE,SHORT-REPORT \?L45
	PRINTR "Taken."
?L45:	PRINTI "You pick up "
	ICALL2 PRINT-DEF,OBJ
	PRINTR "."
...
?L6:	PRINTI "You switch off "
	...
	ICALL2 POINTLESS,STR?23
	RTRUE
?L3:	ICALL2 NOT-POSSIBLE,STR?22
	RTRUE
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 NOT-POSSIBLE,STR?33 >STACK
	RSTACK
...
?L1:	CRLF
	...
	.FUNCT PART-OF
	ICALL2 PRINT-CDEF,PRSO
	PRINTI " seems to be part of "
	LOC PRSO >STACK
	ICALL2 PRINT-DEF,STACK
	PRINTR "."
...
?L0:	SET 'Q,0
	...
	ICALL LEFT-LINE,3,STR?43
	ICALL RIGHT-LINE,3,STR?44,13
...
?L2:	ZERO? Q /?L0
	...
	CURSET 1,1
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?45,16
	CURSET 3,1
	ICALL1 INVERSE-LINE
	ICALL LEFT-LINE,3,STR?43
	ICALL RIGHT-LINE,3,STR?46,17
	CURSET 2,1
	ICALL1 INVERSE-LINE
	HLIGHT H-BOLD
...
?L4:	CLEAR -1
	...
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?45,16
	ICALL LEFT-LINE,2,STR?47
	ICALL RIGHT-LINE,2,STR?48,12
	ZERO? THIRD /FALSE
	ICALL LEFT-LINE,3,STR?49
	CALL RIGHT-LINE,3,STR?50,16 >STACK
	RSTACK
...
?L5:	PRINTR "That would be anti-productive."
	...
	.FUNCT MILK-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "Why would you do that?  You are more than familiar with your own magical milk."
...
?L1:	EQUAL? PRSA,V?SMELL \FALSE
	...
	CALL2 PICK-ONE-R,T?154 >STACK
	PRINT STACK
	CALL2 PICK-ONE-R,T?155 >STACK
	PRINT STACK
	CRLF
	RTRUE
