	...
	.WORD 0
	.WORD 0
	.INSERT "C:\Users\kv\Documents\GitHub\zil-stuff\projects\koww\koww_freq"
	.INSERT "C:\Users\kv\Documents\GitHub\zil-stuff\projects\koww\koww_data"
...
?L1:	GETP HERE,P?ACTION >STACK
	...
	ICALL2 SAVE-PARSER-RESULT,TEMP-PARSER-RESULT
...
?L3:	ZERO? PRSI /?L6
	...
	ZERO? STACK \?L6
?L7:	ICALL2 RESTORE-PARSER-RESULT,TEMP-PARSER-RESULT
	RTRUE
?L6:	ICALL PERFORM,PRSA,PRSO,PRSI
	EQUAL? PRSA,V?QUIT,V?VERSION,V?WAIT /?L13
	EQUAL? PRSA,V?SAVE,V?RESTORE,V?RESTART /?L13
	EQUAL? PRSA,V?INVENTORY,V?UNDO,V?SUPERBRIEF /?L13
	EQUAL? PRSA,V?BRIEF,V?VERBOSE,V?AGAIN /?L13
...
?L1:	PRINTI "Nothing to repeat."
	CRLF
?L22:	ICALL2 RESTORE-PARSER-RESULT,TEMP-PARSER-RESULT
	RTRUE
...
?L1:	EQUAL? PRSA,V?DROP \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE-ON,V?PUT-IN,V?TOSS-INTO \FALSE
...
?L4:	EQUAL? PRSA,V?USE-ON,V?PUT-IN \FALSE
...
?L10:	PRINTR "You look like you're up for an adventure."
	...
	.INSERT "C:\Users\kv\Documents\GitHub\zil-stuff\projects\koww\koww_str"
	.END
