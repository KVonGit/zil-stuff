...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?27 >STACK
	RSTACK
...
?L1:	PRINTI "You contemplate "
	...
	.FUNCT V-LOOK-UNDER
	PRINTR "That was a waste of a good turn."
...
?L60:	EQUAL? MAP-SCOPE-STATUS,MS-NO-LIGHT \?L63
	...
	CRLF
	RFALSE
?L63:	EQUAL? PRSA,V?SMELL \?L66
	PRINTI "You don't smell that here."
	CRLF
	RFALSE
?L66:	PRINTI "You don't see that here."
	CRLF
	RFALSE
...
?L27:	PUTB OUT,0,NOUT
	...
	EQUAL? PRSA,V?TAKE \?L75
	PRINTI " to take"
?L75:	EQUAL? PRSA,V?DROP \?L78
	PRINTI " to drop"
?L78:	PRINTI "!"
	CRLF
	RFALSE
?L73:	SET 'BITS,F
	SET 'OBITS,F
	JUMP ?L1
?L71:	EQUAL? NOUT,1 \?L82
	GET OUT,1 >STACK
	RSTACK
?L82:	EQUAL? MODE?1,MCM-ALL /?L84
	GRTR? NY,1 \?L83
?L84:	RETURN MANY-OBJECTS
?L83:	EQUAL? MODE?1,MCM-ANY \?L85
	RANDOM NOUT >STACK
	GET OUT,STACK >F
	PUT OUT,1,F
	PUTB OUT,0,1
	...
	CRLF
	RETURN F
?L85:	EQUAL? BITS,OBITS /?L87
	SET 'BITS,OBITS
	JUMP ?L1
?L87:	CALL2 APPLY-GENERIC-FCN,OUT >F
	ZERO? F /?L90
	PUT OUT,1,F
	PUTB OUT,0,1
	RETURN F
?L90:	ICALL2 WHICH-DO-YOU-MEAN,OUT
	EQUAL? NP,P-NP-DOBJ \?L93
	SET 'P-O-REASON,32768
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
?L93:	SET 'P-O-REASON,40960
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
...
?L0:	SET 'Q,0
	...
	ICALL LEFT-LINE,3,STR?42
	ICALL RIGHT-LINE,3,STR?43,13
...
?L2:	ZERO? Q /?L0
	...
	CURSET 1,1
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?44,16
	CURSET 3,1
	ICALL1 INVERSE-LINE
	ICALL LEFT-LINE,3,STR?42
	ICALL RIGHT-LINE,3,STR?45,17
	CURSET 2,1
	ICALL1 INVERSE-LINE
	HLIGHT H-BOLD
...
?L4:	CLEAR -1
	...
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?44,16
	ICALL LEFT-LINE,2,STR?46
	ICALL RIGHT-LINE,2,STR?47,12
	ZERO? THIRD /FALSE
	ICALL LEFT-LINE,3,STR?48
	CALL RIGHT-LINE,3,STR?49,16 >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?DROP \?L3
	...
	RSTACK
?L3:	EQUAL? PRSA,V?USE-ON,V?DIG \FALSE
...
?L1:	EQUAL? PRSA,V?DROP \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE,V?CAST \FALSE
	CALL1 FINISH-R >STACK
	RSTACK
...
?L7:	EQUAL? PRSA,V?STAB,V?ATTACK \FALSE
