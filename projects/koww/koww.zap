...
START::
	...
	CRLF
	CRLF
	ICALL2 BOLDIZE,STR?8
	CRLF
	CRLF
	ICALL2 ITALICIZE,STR?9
	CRLF
	CRLF
	ICALL1 V-VERSION
	CRLF
...
?L1:	GETB READBUF,I >STACK
	...
	.FUNCT PRINT-MATCHING-WORD,V,PS,P1,W,CNT,SIZE,I
	ZERO? V \?L1
	PRINTI "---"
	RTRUE
?L1:	SET 'W,VOCAB
...
?L11:	EQUAL? WINNER,OW,0 /FALSE
	...
	LOC WINNER >HERE
?L14:	CALL1 SEARCH-FOR-LIGHT >HERE-LIT
	RETURN HERE-LIT
...
?L5:	ADD PT,PDO-SIZE >PT
	...
	.FUNCT PRINT-PSEUDOS,PDO,MAX,NA,NN,AT,NT,I
	GET PDO,0 >MAX
	ADD PDO,2 >PDO
?L1:	DLESS? 'MAX,0 /TRUE
	GETB PDO,0 >NA
...
?L1:	CALL1 PARSER >?RESULT
	...
	EQUAL? PRSA,V?TELL,V?XTREE,V?XGOTO /?L13
	EQUAL? PRSA,V?XMOVE,V?XREMOVE,V?XLIGHT /?L13
	EQUAL? PRSA,V?XEXITS,V?XOBJ,V?XIT /?L13
...
?L4:	PRINTI "Darkness"
?L6:	GETB 0,33 >WIDTH
	EQUAL? SCORING-ENABLED,1 \?L7
	EQUAL? SHOW-SCORE-IN-STATUS,1 \?L7
	SUB WIDTH,22 >STACK
	CURSET 1,STACK
	PRINTI "Score: "
	PRINTN SCORE
?L7:	EQUAL? SHOW-MOVES-IN-STATUS,1 \?L10
	SUB WIDTH,10 >STACK
	CURSET 1,STACK
	PRINTI "Moves: "
	PRINTN MOVES
...
?L14:	ICALL2 PRINT-INDEF,O
	...
	.FUNCT TELL-CANT-GO-THAT-WAY,TEXT
	ZERO? TEXT \?L1
	CALL2 PICK-ONE,NO-EXITS >STACK
	PRINT STACK
	CRLF
	RTRUE
?L1:	PRINT TEXT
...
?L3:	FSET? PRSO,CONTBIT /?L4
	CALL2 NOT-POSSIBLE,STR?11 >STACK
	RSTACK
...
?L29:	CALL TAKE-CAPACITY-CHECK,OBJ,SILENT >STACK
	...
	MOVE OBJ,WINNER
	ZERO? SILENT \TRUE
	EQUAL? REPORT-MODE,SHORT-REPORT \?L44
	PRINTR "Taken."
?L44:	PRINTI "You pick up "
	ICALL2 PRINT-DEF,OBJ
	PRINTR "."
...
?L3:	FSET PRSO,TOUCHBIT
	FCLEAR PRSO,WORNBIT
	EQUAL? REPORT-MODE,SHORT-REPORT \?L4
	PRINTR "Dropped."
?L4:	PRINTI "You drop "
	ICALL2 PRINT-DEF,PRSO
	PRINTR "."
...
?L3:	RETURN W
	...
	ICALL2 PRINT-DEF,PRSO
	PRINTR "."
?L3:	FSET PRSO,WORNBIT
	PRINTI "You put "
	ICALL2 PRINT-DEF,PRSO
	PRINTR " on."
?L1:	ICALL2 NOT-POSSIBLE,STR?17
	RTRUE
...
?L9:	ICALL PERFORM,PRSA,PRSO,PRSI
	...
	EQUAL? PRSA,V?TELL,V?XTREE,V?XGOTO /?L16
	EQUAL? PRSA,V?XMOVE,V?XREMOVE,V?XLIGHT /?L16
	EQUAL? PRSA,V?XEXITS,V?XOBJ,V?XIT /?L16
	GETP HERE,P?ACTION >STACK
	ICALL2 STACK,M-END
	ICALL1 CLOCKER
?L16:	LOC WINNER >STACK
	...
	LOC WINNER >HERE
?L25:	ICALL2 RESTORE-PARSER-RESULT,TEMP-PARSER-RESULT
	RTRUE

	.FUNCT V-READ,T
	FSET? PRSO,READBIT /?L1
	ICALL2 NOT-POSSIBLE,STR?22
	RTRUE
...
?L6:	PRINTI "You switch off "
	...
	ICALL2 POINTLESS,STR?24
	RTRUE
?L3:	ICALL2 NOT-POSSIBLE,STR?23
	RTRUE
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	ICALL1 YOU-MASHER
	RTRUE
?L3:	ICALL2 POINTLESS,STR?26
	RTRUE

	.FUNCT V-DRINK
	PRINTR "That's hardly potable."
...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?29 >STACK
	RSTACK
...
?L1:	CRLF
	...
	EQUAL? O,NUMBER \?L1
	LESS? P-NUMBER,1 /?L3
	GRTR? P-NUMBER,LAST-OBJECT /?L3
	RETURN P-NUMBER
?L3:	PRINTI "[Bad objref.]"
	CRLF
	RFALSE
?L1:	RETURN O

	.FUNCT V-XTREE,OFL,ROOT,L,I
	GET 0,8 >OFL
	BOR OFL,2 >STACK
	PUT 0,8,STACK
	PUTB TREE-INDENT,0,0
	CALL2 OBJREF?,PRSO >ROOT
	ZERO? ROOT /?L1
	LOC ROOT >L
	ZERO? L /?L3
	ICALL2 PRINT-OBJREF,L
	CRLF
?L3:	ICALL2 TREE-FROM,ROOT
	JUMP ?L9
?L1:	SET 'I,LAST-OBJECT
?L7:	IN? I,0 \?L10
	ICALL2 TREE-FROM,I
?L10:	DLESS? 'I,1 \?L7
?L9:	PUT 0,8,OFL
	...
	.FUNCT TREE-FROM,O,I,C,N
	ICALL1 PRINT-TREE-INDENT
	PRINTI "- "
	ICALL2 PRINT-OBJREF,O
	CRLF
	GETB TREE-INDENT,0 >I
	ZERO? I /?L1
	GETB TREE-INDENT,I >STACK
	EQUAL? STACK,96 \?L1
	PUTB TREE-INDENT,I,32
?L1:	INC 'I
	PUTB TREE-INDENT,I,32
	INC 'I
	PUTB TREE-INDENT,I,32
	INC 'I
	PUTB TREE-INDENT,I,124
	PUTB TREE-INDENT,0,I
	FIRST? O >C \?L6
?L4:	NEXT? C >N /?L8
	PUTB TREE-INDENT,I,96
?L8:	ICALL2 TREE-FROM,C
	SET 'C,N
	ZERO? C \?L4
?L6:	SUB I,3 >STACK
	PUTB TREE-INDENT,0,STACK
	RTRUE

	.FUNCT PRINT-TREE-INDENT,MAX,I
	GETB TREE-INDENT,0 >MAX
	ZERO? MAX /TRUE
	SET 'I,1
?L3:	GETB TREE-INDENT,I >STACK
	PRINTC STACK
	IGRTR? 'I,MAX \?L3
	RTRUE

	.FUNCT PRINT-OBJREF,O
	ZERO? O \?L1
	PRINTI "<>"
	JUMP ?L7
?L1:	EQUAL? O,ROOMS \?L3
	PRINTI "ROOMS"
	JUMP ?L7
?L3:	EQUAL? O,GLOBAL-OBJECTS \?L4
	PRINTI "GLOBAL-OBJECTS"
	JUMP ?L7
?L4:	EQUAL? O,LOCAL-GLOBALS \?L5
	PRINTI "LOCAL-GLOBALS"
	JUMP ?L7
?L5:	EQUAL? O,GENERIC-OBJECTS \?L6
	PRINTI "GENERIC-OBJECTS"
	JUMP ?L7
?L6:	PRINTD O
?L7:	PRINTI " ("
	PRINTN O
...
?L5:	PRINTI " = "
	...
	.FUNCT PRINT-FLAGREF,N,MAX,I
	PRINTN N
	GET FLAG-NAMES,0 >MAX
	SET 'I,1
?L1:	GET FLAG-NAMES,I >STACK
	EQUAL? STACK,N \?L4
	PRINTI " ("
	ADD I,1 >STACK
	GET FLAG-NAMES,STACK >STACK
	PRINT STACK
	PRINTI ")"
	RTRUE
?L4:	ADD I,2 >I
	...
	ZERO? PRSI \?L1
	SET 'PRSI,WINNER
?L1:	CALL2 OBJREF?,PRSO >V
	ZERO? V /FALSE
	CALL2 OBJREF?,PRSI >D
	ZERO? D /FALSE
	MOVE V,D
	PRINTI "Moved "
	ICALL2 PRINT-OBJREF,V
	PRINTI " to "
	ICALL2 PRINT-OBJREF,D
	PRINTR "."
	...
	.FUNCT V-XLIGHT
	FSET? WINNER,LIGHTBIT \?L1
	FCLEAR WINNER,LIGHTBIT
	PRINTI "You stop glowing."
	CRLF
	CALL1 NOW-DARK? >STACK
	RSTACK
?L1:	FSET WINNER,LIGHTBIT
	PRINTI "You're now glowing."
	CRLF
	CALL1 NOW-LIT? >STACK
	RSTACK

	.FUNCT V-XEXITS,R,S,M,D,PT
	ZERO? PRSO /?L1
	CALL2 OBJREF?,PRSO >R
	JUMP ?L3
?L1:	SET 'R,HERE
?L3:	ZERO? R /TRUE
	ICALL2 PRINT-OBJREF,R
	CRLF
	SET 'D,64
?L6:	DLESS? 'D,P?DOWN /TRUE
	GETPT R,D >PT
	ZERO? PT /?L6
	ICALL PRINT-MATCHING-WORD,D,PS?DIRECTION,P1?DIRECTION
	PRINTI " -> "
	PTSIZE PT >S
	EQUAL? S,UEXIT \?L9
	PRINTI "TO "
	GET PT,EXIT-RM >STACK
	ICALL2 PRINT-OBJREF,STACK
	JUMP ?L21
?L9:	EQUAL? S,NEXIT \?L11
	PRINTI "SORRY """
	GET PT,NEXIT-MSG >STACK
	PRINT STACK
	PRINTI """"
	JUMP ?L21
?L11:	EQUAL? S,FEXIT \?L12
	PRINTI "PER "
	GET PT,FEXIT-RTN >STACK
	PRINTN STACK
	JUMP ?L21
?L12:	EQUAL? S,CEXIT \?L13
	PRINTI "TO "
	GET PT,EXIT-RM >STACK
	ICALL2 PRINT-OBJREF,STACK
	PRINTI " IF "
	GETB PT,CEXIT-VAR >STACK
	ICALL2 PRINT-VARREF,STACK
	GET PT,CEXIT-MSG >M
	ZERO? M /?L21
	PRINTI " ELSE """
	PRINT M
...
?L21:	CRLF
	...
	.FUNCT V-XOBJ,O,F,PT,MAX,I
	CALL2 OBJREF?,PRSO >O
	ZERO? O /TRUE
	ICALL2 PRINT-OBJREF,O
	CRLF
	PRINTI "Adjectives: "
	GETPT O,P?ADJECTIVE >PT
	ZERO? PT /?L8
	PTSIZE PT >MAX
	ZERO? MAX /?L8
	DIV MAX,2 >MAX
...
?L27:	GET PT,I >STACK
	ICALL2 PRINT-OBJREF,STACK
	IGRTR? 'I,MAX \?L24
?L26:	GETP O,P?THINGS >PT
	ZERO? PT /?L31
	CRLF
	PRINTI "Pseudos: "
	ICALL2 PRINT-PSEUDOS,PT
?L31:	CRLF
	PRINTI "Flags: "
	SET 'I,0
?L34:	FSET? O,I \?L37
...
?L37:	IGRTR? 'I,47 \?L34
	...
	PUT P-PRO-IT-OBJS,1,O
	PRINTI "IT now refers to "
	ICALL2 PRINT-OBJREF,O
	PRINTR "."
...
?L3:	PRINTI "You can't cross "
	...
	.FUNCT V-YES
	EQUAL? PRINTED-RHETORICAL,1 \?L1
	SET 'PRINTED-RHETORICAL,0
	ICALL1 RHETORICAL
	RTRUE
?L1:	PRINTR "You sound rather positive!"
...
?L5:	PRINTI "You devour "
	ICALL2 PRINT-DEF,PRSO
	PRINTR "."
?L4:	PRINTR "That doesn't look appetizing. You chew your cud instead."
...
?L54:	INC 'NOUT
	...
	PUT OUT,NOUT,STACK
?L55:	ZERO? F \?L58
?L103:	EQUAL? BITS,-1 /?L60
	SET 'BITS,-1
	SET 'OBITS,-1
	JUMP ?L1
?L60:	EQUAL? MAP-SCOPE-STATUS,MS-NO-LIGHT \?L63
	PRINTI "It's too dark to "
	EQUAL? PRSA,V?SMELL \?L65
	PRINTI "smell"
	JUMP ?L67
?L65:	PRINTI "see"
?L67:	PRINTI " anything here."
	CRLF
	RFALSE
?L63:	EQUAL? PRSA,V?SMELL \?L69
	PRINTI "You don't smell that here."
	CRLF
	RFALSE
?L69:	PRINTI "You don't see that here."
	CRLF
	RFALSE
...
?L27:	PUTB OUT,0,NOUT
	...
	EQUAL? BITS,F \?L76
	PRINTI "There is no 'all'"
	EQUAL? PRSA,V?TAKE \?L78
	PRINTI " to take"
?L78:	EQUAL? PRSA,V?DROP \?L81
	PRINTI " to drop"
?L81:	PRINTI "!"
	CRLF
	RFALSE
?L76:	SET 'BITS,F
	SET 'OBITS,F
	JUMP ?L1
?L74:	EQUAL? NOUT,1 \?L85
	GET OUT,1 >STACK
	RSTACK
?L85:	EQUAL? MODE?1,MCM-ALL /?L87
	GRTR? NY,1 \?L86
?L87:	RETURN MANY-OBJECTS
?L86:	EQUAL? MODE?1,MCM-ANY \?L88
	RANDOM NOUT >STACK
	GET OUT,STACK >F
	PUT OUT,1,F
	PUTB OUT,0,1
	...
	CRLF
	RETURN F
?L88:	EQUAL? BITS,OBITS /?L90
	SET 'BITS,OBITS
	JUMP ?L1
?L90:	CALL2 APPLY-GENERIC-FCN,OUT >F
	ZERO? F /?L93
	PUT OUT,1,F
	PUTB OUT,0,1
	RETURN F
?L93:	ICALL2 WHICH-DO-YOU-MEAN,OUT
	EQUAL? NP,P-NP-DOBJ \?L96
	SET 'P-O-REASON,32768
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
?L96:	SET 'P-O-REASON,40960
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
	...
	FSET? OBJ,NALLBIT /FALSE
	EQUAL? OBJ,WINNER /FALSE
	EQUAL? PRSA,V?TAKE \?L3
	LOC OBJ >STACK
	EQUAL? STACK,WINNER /FALSE
?L3:	EQUAL? PRSA,V?DROP \?L4
	LOC OBJ >STACK
	EQUAL? STACK,WINNER \FALSE
?L4:	EQUAL? PRSA,V?TAKE,V?DROP \TRUE
	FSET? OBJ,TAKEBIT /TRUE
	FSET? OBJ,TRYTAKEBIT /TRUE
	RFALSE

	.FUNCT V-LOOK-UNDER
	PRINTR "You don't need to look under anything in this game."
...
?L0:	SET 'Q,0
	...
	ICALL LEFT-LINE,3,STR?44
	ICALL RIGHT-LINE,3,STR?45,13
...
?L2:	ZERO? Q /?L0
	...
	CURSET 1,1
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?46,16
	CURSET 3,1
	ICALL1 INVERSE-LINE
	ICALL LEFT-LINE,3,STR?44
	ICALL RIGHT-LINE,3,STR?47,17
	CURSET 2,1
	ICALL1 INVERSE-LINE
	HLIGHT H-BOLD
...
?L4:	CLEAR -1
	...
	ICALL1 INVERSE-LINE
	ICALL CENTER-LINE,1,STR?46,16
	ICALL LEFT-LINE,2,STR?48
	ICALL RIGHT-LINE,2,STR?49,12
	ZERO? THIRD /FALSE
	ICALL LEFT-LINE,3,STR?50
	CALL RIGHT-LINE,3,STR?51,16 >STACK
	RSTACK
...
?L1:	EQUAL? PRSA,V?DROP \?L3
	PRINTI "Dropping "
	ICALL2 PRINT-DEF,PRSO
	PRINTR " would be anti-productive."
?L3:	EQUAL? PRSA,V?PUT-IN /?L5
	EQUAL? PRSA,V?PUT-ON \FALSE
?L5:	PRINTR "That would be anti-productive."

	.FUNCT MILK-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTI "Why would you do that?  You are more than familiar with your own magical milk.
"
	RTRUE
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	PRINTR "Why would you do that?  Awful waste of milk."
?L3:	EQUAL? PRSA,V?GIVE \?L4
	...
	ICALL2 THIS-IS-IT,PITCHFORK
	RTRUE
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "Zeke is quite fond of your magic milk, but you can only GIVE so much each day."

	.FUNCT PITCHFORK-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "A sharp-looking tool!"
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE-ON,V?DIG \?L4
	EQUAL? PRSA,V?USE-ON \?L8
	EQUAL? PRSI,HAYSTACK /?L7
?L8:	EQUAL? PRSA,V?DIG \FALSE
	EQUAL? PRSO,HAYSTACK \FALSE
?L7:	ICALL1 OPEN-STATUE-CAVE-R
	RTRUE
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "Hmm... You think there's probably something to use the pitchfork on, in much the same way Farmer Zeke sometimes uses it."

	.FUNCT FLY-SCROLL-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "Try using it (when in the proper location)."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE,V?CAST \?L4
	CALL1 FINISH-R >STACK
	RSTACK
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You need to be in the proper location to use it."

	.FUNCT WING-FEATHER-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "A wing feather from a Phoenix."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You should probably find its original owner."

	.FUNCT JADE-STATUETTE-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "The ugly statuette is a waste of jade."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?GIVE \?L4
	...
	RSTACK
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "It seems like a gift fit for a king!"

	.FUNCT GOBLIN-SPIT-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "Yuck... It's chunky!"
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?SMELL \?L4
	PRINTR "Yuck!"
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTI "After a turn of thinking, you "
	FSET? LAND-OF-NECROYAKS,TOUCHBIT \?L6
	PRINTI "remember a sign somewhere saying something about acid"
	JUMP ?L8
?L6:	PRINTI "decide you need to explore a little more to find a place to use it"
?L8:	PRINTR "."

	.FUNCT SOMETHING-ITEM-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "About what you'd expect something to look like in this game."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE-ON,V?PUT-IN \?L4
	EQUAL? PRSI,POND \FALSE
	CALL1 GET-DUCK-TURD-R >STACK
	RSTACK
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You think about it for a complete turn, and you decide you should simply put something in the pond!"

	.FUNCT NOTHING-ITEM-R
	EQUAL? PRSA,V?SMELL \?L1
	PRINTR "You smell nothing."
?L1:	EQUAL? PRSA,V?EXAMINE \?L3
	PRINTR "It doesn't look like much of anything!"
?L3:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L4
	PRINTR "Are you serious?"
?L4:	EQUAL? PRSA,V?GIVE \?L5
	EQUAL? PRSI,GOBLIN-GUARD \FALSE
	CALL1 SECRET-ONE-R >STACK
	RSTACK
?L5:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "Perhaps you can find someone who'll give you something for nothing?"

	.FUNCT DUCK-TURD-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "About what you'd expect, obviously dropped by something fowl."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?GIVE \?L4
...
?L4:	EQUAL? PRSA,V?SMELL \?L8
	CALL1 SILLY >STACK
	RSTACK
?L8:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You decide you should find a disgusting NPC who might want it."

	.FUNCT GRAPPLING-HOOK-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "It looks strong enough to support a cow!"
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE \?L4
	LOC PLAYER >STACK
	EQUAL? STACK,MOUNTAINS \FALSE
	CALL1 CLIMB-THEM-R >STACK
	RSTACK
?L4:	EQUAL? PRSA,V?USE-ON \?L8
	EQUAL? PRSO,MOUNTAINS \FALSE
	CALL1 CLIMB-THEM-R >STACK
	RSTACK
?L8:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "It doesn't even take you the full turn to realize that this needs to be used to climb something."

	.FUNCT PURPLE-PAINT-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "It's paint, and it's purple."
?L1:	EQUAL? PRSA,V?DROP,V?PUT-IN,V?PUT-ON \?L3
	CALL1 QUEST-TWO-R >STACK
	RSTACK
?L3:	EQUAL? PRSA,V?USE \?L4
...
?L9:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You probably need to be in the right place before you try to use it."
...
?L1:	PRINTR "You don't know where that is."
	...
	CRLF
	CALL2 INCREMENT-SCORE,15 >STACK
	RSTACK
...
?L6:	EQUAL? PRSA,V?DRINK \?L7
	PRINTR "What, drink THAT?!?!?  You loony."
?L7:	EQUAL? PRSA,V?STAB,V?ATTACK \?L8
	CALL1 OPEN-STATUE-CAVE-R >STACK
	RSTACK
?L8:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	FSET? JADE-STATUETTE,TOUCHBIT \?L10
	PRINTR "It has no more purpose in this game."
?L10:	CALL2 HELD?,PITCHFORK >STACK
	ZERO? STACK /?L12
	PRINTR "Hmmm... You think you probably have the proper tool to use on it...."
?L12:	PRINTR "It seems important. Maybe you just need something else first."
	...
	ICALL2 THIS-IS-IT,JADE-STATUETTE
	CALL2 INCREMENT-SCORE,15 >STACK
	RSTACK
...
?L3:	EQUAL? PRSA,V?EAT \?L4
	PRINTR "That doesn't look appetizing. You chew your cud instead."
?L4:	EQUAL? PRSA,V?USE-ON,V?PUT-IN \?L5
	EQUAL? PRSO,SOMETHING-ITEM \FALSE
	CALL1 GET-DUCK-TURD-R >STACK
	RSTACK
?L5:	EQUAL? PRSA,V?SMELL \?L9
	PRINTR "It smells like pond water and duck turds."
?L9:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You've always gotten a kick out of putting something into ponds like this..."
...
?L1:	EQUAL? PRSA,V?CLOSE \?L3
	...
	PRINTR "It appears to be stuck open, but that's okay. We're done with it now."
?L4:	PRINTR "It's already closed."
?L3:	EQUAL? PRSA,V?TAKE \FALSE
	PRINTI "It's too big."
	FSET? TREASURE-CHEST,OPENBIT /?L8
	PRINTI " You could open it instead..."
?L8:	CRLF
	RTRUE

	.FUNCT GET-NOTHING-R
	FSET? NOTHING-ITEM,TOUCHBIT /FALSE
...
?L4:	EQUAL? PRSA,V?SPLASH \?L5
	CALL1 DUMB-LOSE-R >STACK
	RSTACK
?L5:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "He LOVES your magic milk, and purple cows!"
...
?L3:	EQUAL? PRSA,V?CLIMB \FALSE
	...
	EQUAL? PRSA,V?ENTER \FALSE
	CALL1 GOTO-LAIR >STACK
	RSTACK

	.FUNCT GOTO-LAIR
	SET 'PRSO,INSIDE-GOBLIN-LAIR-ENTRANCE
	CALL1 V-ENTER >STACK
	RSTACK
...
?L3:	EQUAL? PRSA,V?SMELL \?L4
	...
	RSTACK
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "He seems to want nothing."
	...
	ICALL2 THIS-IS-IT,SOMETHING-ITEM
	CALL2 INCREMENT-SCORE,10 >STACK
	RSTACK
...
?L4:	PRINTR """"
?L3:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "Just speak to him. If he wants something, he'll pretty much say so."
	...
	PRINTI """Ooooo!  You find goblinn lost statyoo!  We giv yu wun jar of spit!"""
	CRLF
	CALL2 INCREMENT-SCORE,5 >STACK
	RSTACK
	...
	PRINTI """Ooooo!  GIMME GIMME GIMME!  Duck turd favorite goblin food!  We giv yu grapple hook!"""
	CRLF
	CALL2 INCREMENT-SCORE,5 >STACK
	RSTACK
...
?L3:	EQUAL? RARG,M-BEG \FALSE
	EQUAL? PRSA,V?CLIMB-MOD \FALSE
	PRINTR "It's steep -- you can't climb."
	...
	ICALL2 THIS-IS-IT,WING-FEATHER
	CALL2 INCREMENT-SCORE,10 >STACK
	RSTACK
...
?L3:	EQUAL? PRSA,V?CLIMB \?L4
	...
	RSTACK
?L4:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "You think they could be climbed, with the proper tool."
	...
	ICALL2 THIS-IS-IT,PURPLE-PAINT
	PRINTI "On top of the mountain, you find a bunch of purple paint, which you take.  After descending again, you ditch your grappling hook."
	CRLF
	CALL2 INCREMENT-SCORE,10 >STACK
	RSTACK
...
?L4:	PRINTI "demands to know "
	...
	ICALL2 ITALICIZE,STR?74
	PRINTI "  Now, do you have my wing feather or not?"" -- "
	CRLF
	ICALL2 BOLDIZE,STR?75
	PRINTI " or "
	ICALL2 BOLDIZE,STR?76
	PRINTI "? "
	CALL1 YES? >STACK
	ZERO? STACK /?L7
	CRLF
	CALL2 HELD?,WING-FEATHER >STACK
	ZERO? STACK /?L9
	CALL1 PHOENIX-PROC-R >STACK
	RSTACK
?L9:	CALL1 PHOENIX-KILL-R >STACK
	RSTACK
?L7:	CRLF
	PRINTR """Then leave me immediately, as I do not appreciate company."""
?L3:	EQUAL? PRSA,V?THINK-ABOUT \FALSE
	PRINTR "Just speak to him."
...
?L3:	PRINTR "Maybe you'll find it someday, but you don't have it today. You stupid cow."
	...
	PRINT WIN-TEXT
	CRLF
	PRINTI "[PRESS RETURN OR ENTER TO VIEW YOUR SCORE.]"
	ICALL1 READLINE
	CRLF
	PRINTI "You scored "
	PRINTN SCORE
...
?L1:	EQUAL? PRSA,V?SMELL \FALSE
	...
	.FUNCT KOWW-PACK-R
	EQUAL? PRSO,KOWW-PACK \FALSE
	CALL2 PICK-ONE-R,T?166 >STACK
	PRINT STACK
	CALL2 PICK-ONE-R,T?167 >STACK
	PRINT STACK
	CRLF
	RTRUE
...
?L7:	PRINTR "They STINK!!!"
	...
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "You can't see him from here."
?L1:	EQUAL? PRSA,V?SMELL \FALSE
	LOC ZEKE >STACK
	EQUAL? STACK,HERE \?L4
	PRINTR "He smells like magic milk."
?L4:	PRINTR "He seems to be... in the silo."
