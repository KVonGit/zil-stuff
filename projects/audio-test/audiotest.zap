	...
	.WORD 0
	.WORD 0
	.INSERT "audiotest_freq"
	.INSERT "audiotest_data"
...
?L4:	SET 'WINNER,PLAYER
	...
	LOC WINNER >HERE
?L16:	CALL1 SEARCH-FOR-LIGHT >HERE-LIT
	ICALL2 READLINE,1
?L15:	GETB LEXBUF,1 >P-LEN
	...
	SET 'P-CONT,0
	RFALSE
?L19:	LESS? P-LEN,1 /?L22
	CALL2 GETWORD?,1 >STACK
	EQUAL? STACK,W?UNDO \?L22
	EQUAL? P-LEN,1 /?L30
...
?L30:	ZERO? P-CONT \?L41
	...
	GETB LEXBUF,1 >P-LEN
	JUMP ?L41
?L37:	PRINTI "Nothing to correct."
	CRLF
	RFALSE
?L35:	EQUAL? P-LEN,1 \?L40
	PRINTI "It's OK."
	CRLF
	RFALSE
?L40:	PRINTI "You can only correct one word at a time."
	CRLF
	RFALSE
?L41:	SET 'KEEP,0
	...
	ZERO? P-CONT \?L73
	EQUAL? READBUF,EDIT-READBUF /?L46
...
?L46:	ZERO? P-O-REASON /?L53
	CALL1 HANDLE-ORPHAN-RESPONSE >O-R
	EQUAL? O-R,O-RES-NOT-HANDLED /?L55
	SET 'WINNER,OW
	SET 'HERE,OH
	SET 'HERE-LIT,OHL
?L55:	EQUAL? O-R,O-RES-REORPHANED /FALSE
	EQUAL? O-R,O-RES-FAILED \?L60
	SET 'P-O-REASON,0
	RFALSE
?L60:	EQUAL? O-R,O-RES-SET-NP \?L61
	GETB P-SYNTAX,SYN-PREP1 >P-P1
	BTST P-O-REASON,P-OF-PRSI \?L62
...
?L62:	SET 'P-NOBJ,1
	JUMP ?L68
?L61:	EQUAL? O-R,O-RES-SET-PRSTBL \?L68
	BTST P-O-REASON,P-OF-PRSI \?L66
	SET 'KEEP,2
	JUMP ?L68
?L66:	SET 'KEEP,1
?L68:	SET 'P-O-REASON,0
?L53:	ZERO? O-R \?L73
	CALL1 CONVERT-ORDER-TO-TELL? >STACK
	ZERO? STACK /?L73
	GETB LEXBUF,1 >P-LEN
?L73:	EQUAL? O-R,O-RES-SET-NP,O-RES-SET-PRSTBL /?L78
	SET 'P-V,0
	SET 'P-NOBJ,0
	...
	ZERO? RES \?L80
	SET 'RES,1
?L80:	GRTR? RES,P-LEN \?L84
	SET 'P-CONT,0
	JUMP ?L83
?L84:	CALL2 GETWORD?,RES >W
	ZERO? W \?L86
	CALL2 PARSE-NUMBER?,RES >STACK
	ZERO? STACK /?L87
	SET 'W,W?$002cNUMBER
	ZERO? W \?L86
?L87:	ICALL2 STORE-OOPS,RES
	SET 'P-CONT,0
	...
	CRLF
	RFALSE
?L86:	EQUAL? W,W?THEN,W?$PERIOD \?L88
	ADD RES,1 >P-CONT
	GRTR? P-CONT,P-LEN \?L89
	SET 'P-CONT,0
	JUMP ?L83
?L89:	ICALL COPY-READBUF,READBUF,CONT-READBUF
...
?L88:	ZERO? P-V \?L94
	...
	ZERO? V /?L94
	ZERO? DIR /?L95
	EQUAL? V,ACT?WALK \?L94
?L95:	SET 'P-V-WORD,W
	SET 'P-V-WORDN,RES
	SET 'P-V,V
	JUMP ?L113
?L94:	ZERO? DIR \?L96
	EQUAL? P-V,0,ACT?WALK \?L96
	CALL CHKWORD?,W,PS?DIRECTION,P1?DIRECTION >VAL
	ZERO? VAL /?L96
	SET 'DIR,VAL
	SET 'DIR-WN,RES
	JUMP ?L113
?L96:	CALL CHKWORD?,W,PS?PREPOSITION,0 >VAL
	ZERO? VAL /?L97
	ZERO? NOBJ \?L98
	ZERO? P-P1 \?L98
	SET 'P-P1,VAL
	JUMP ?L113
?L98:	EQUAL? NOBJ,1 \?L113
	ZERO? P-P2 \?L113
	SET 'P-P2,VAL
	JUMP ?L113
?L97:	CALL2 STARTS-NOUN-PHRASE?,W >STACK
	ZERO? STACK /?L102
	INC 'NOBJ
	EQUAL? NOBJ,1 \?L103
	ZERO? DIR /?L105
	...
	SET 'DIR,0
	SET 'DIR-WN,0
?L105:	CALL PARSE-NOUN-PHRASE,RES,P-NP-DOBJ >VAL
	JUMP ?L109
?L103:	EQUAL? NOBJ,2 \?L108
...
?L129:	SET 'P-CONT,0
	RFALSE
?L125:	LESS? KEEP,2 \?L132
	CALL2 FIND-OBJECTS,KEEP >STACK
	ZERO? STACK \?L132
	SET 'P-CONT,0
	RFALSE
?L132:	EQUAL? PRSA,V?AGAIN /?L136
	ICALL2 SAVE-PARSER-RESULT,AGAIN-STORAGE
?L136:	ICALL SET-PRONOUNS,PRSO,P-PRSOS
	RTRUE
...
?L1:	GETPT HERE,PRSO >PT
	...
	ZERO? STACK \?L4
?L6:	ICALL1 TELL-CANT-GO-THAT-WAY
?L4:	SET 'P-CONT,0
	RTRUE
?L3:	PTSIZE PT >PTS
	EQUAL? PTS,UEXIT \?L8
...
?L18:	ZERO? HERE-LIT \?L20
	CALL2 DARKNESS-F,M-DARK-CANT-GO >STACK
	ZERO? STACK \?L21
?L20:	ICALL1 TELL-CANT-GO-THAT-WAY
?L21:	SET 'P-CONT,0
	RTRUE
...
?L5:	PRINTI "   "
	...
	GETP I,P?SUFFIX >STACK
	ZERO? STACK /?L8
	PRINTI " "
	GETP I,P?SUFFIX >STACK
	PRINT STACK
?L8:	FSET? I,WORNBIT \?L10
	PRINTI " (worn)"
?L10:	FSET? I,LIGHTBIT \?L12
	PRINTI " (providing light)"
?L12:	FSET? I,CONTBIT \?L22
	FSET? I,OPENABLEBIT \?L20
	FSET? I,OPENBIT \?L18
	PRINTI " (open)"
	JUMP ?L20
?L18:	PRINTI " (closed)"
?L20:	CALL2 SEE-INSIDE?,I >STACK
	ZERO? STACK /?L22
...
?L3:	ICALL2 POINTLESS,STR?20
	...
	.FUNCT V-YES
	PRINTI "You sound very positive!"
	RTRUE

	.FUNCT V-NO
	PRINTI "You sound rather negative."
	RTRUE
...
START::
	...
	PRINTI "You (should) hear a bleep. (1)"
	CRLF
	SOUND 1
	RTRUE
	...
	.FUNCT BLUE-BUTTON-F
	EQUAL? PRSA,V?PUSH \FALSE
	PRINTI "You (should) hear a bloop. (2)"
	CRLF
	SOUND 2,2,8,YELLOW-CALLBACK
	RTRUE

	.FUNCT YELLOW-BUTTON-R
	EQUAL? PRSA,V?PUSH \FALSE
	PRINTI "You (should) hear a DUMMY. (3)"
	CRLF
	SOUND 3,2,8,YELLOW-CALLBACK
	RTRUE

	.FUNCT YELLOW-CALLBACK
	PRINTI "
YELLOW DUMMY FINISHED PLAYING."
	CRLF
	PRINTI ">"
	RTRUE
	...
	.FUNCT RED-BUTTON-F
	EQUAL? PRSA,V?PUSH \FALSE
	PRINTI "All sounds should now stop, if any are playing. (0 3)"
	CRLF
	SOUND 0,3
	RTRUE

	.INSERT "audiotest_str"
	.END
