	...
	.WORD 0
	.WORD 0
	.INSERT "drumsticks_freq"
	.INSERT "drumsticks_data"

	.FUNCT GO
START::
	CRLF
	CRLF
	PRINTI "You have just eaten a huge breakfast fry-up, including a couple of rather gristly sausages. The grease sits heavy in your stomach.

You are contemplating what to do today, when in bursts Robin Lye, the local music promoter. He dashes over to you, panting for breath, and says, 'you still managing that band? The Bony Kings?'

You nod. 'Yep. For my sins.'

'Well, then,' says Robin. 'We might be able to do each other a favour. I need a support band for tonight. I've got Get Lamp booked in to play the Blackfriar's Inn, and the support have dropped out. The gig is sold out. There is a grand in the hand for you and the band if you can fill the slot. What do you say?' 

You pause for a moment. The water bill you opened this morning flashes through your mind, and you say, 'alright. I'll get the band and equipment together.'

'Nice one,' says Robin. 'Soundcheck is at 5pm, don't be late. I'm off. Oh... Hi, Jon.'

Jon nods but continues chewing the last of his fried egg sandwich.

'Right, see you later,' says Robin and dashes out of the café. A few seconds later, he pops his head around the door again and says, 'oh, do me a favour and find me a DJ to warm the crowd up before the support.' You give him a thumbs up, and he dashes off again.

'Right,' you say to Jonny. 'We need to get the band together, find a DJ, pick up the equipment from the rehearsal rooms with the van and get over to the Blackfriar's Inn.'

'OK, Boss,' says Jonny, 'but er... there is one small problem. The van is fucked.'"
	CRLF
	CRLF
	ICALL1 V-VERSION
	CRLF
	SET 'HERE,GREASY-SPOON-CAFE
	MOVE PLAYER,HERE
	ICALL1 V-LOOK
?L1:	CALL1 PARSER >STACK
	ZERO? STACK /?L5
	ICALL PERFORM,PRSA,PRSO,PRSI
	EQUAL? PRSA,V?QUIT,V?VERSION,V?WAIT /?L5
	EQUAL? PRSA,V?SAVE,V?RESTORE,V?RESTART /?L5
	EQUAL? PRSA,V?INVENTORY,V?UNDO,V?SUPERBRIEF /?L5
	EQUAL? PRSA,V?BRIEF,V?VERBOSE,V?AGAIN /?L5
	EQUAL? PRSA,V?SCRIPT,V?UNSCRIPT,V?PRONOUNS /?L5
	EQUAL? PRSA,V?TELL /?L5
