...
?L1:	EQUAL? PRSA,V?HACK \FALSE
	...
	.FUNCT V-RIDE
	PRINTR "You can't ride that."

	.FUNCT HORSE-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "A perfectly ordinary horse."
?L1:	EQUAL? PRSA,V?RIDE \FALSE
	SET 'HORSEBACK,1
	FSET HORSE,NDESCBIT
	PRINTR "You mount the horse."
...
?L28:	CALL2 GOTO,RM >STACK
	...
	EQUAL? HORSEBACK,1 \?L6
	PRINTR "You can't enter the hovel on the horse."
