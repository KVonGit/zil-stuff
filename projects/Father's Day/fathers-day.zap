...
?L1:	CRLF
	...
	.FUNCT CEMETERY-R,RARG
	EQUAL? RARG,M-BEG \FALSE
	EQUAL? PRSA,V?WALK \FALSE
	EQUAL? ZOMBIE-HAND-GOT-YA,1 \FALSE
	PRINTI "You can't go anywhere! The hand is holding onto you and you can't walk!!!"
	CRLF
	SET 'P-CONT,-1
	RETURN 2
...
The zombie slowly limps towards you..."
?L3:	EQUAL? ZOMBIE-BITE-COUNTDOWN,1 \?L5
	PRINTR "
...
The zombie stands silently beside you, mumbling and groaning."
	...
	EQUAL? ZOMBIE-HAND-GOT-YA,1 \?L3
	SET 'ZOMBIE-HAND-GOT-YA,0
...
?L8:	CRLF
	...
	PRINTR "It wouldn't be able to support you."
...
?L1:	EQUAL? PRSA,V?READ \FALSE
	...
	PRINTI "It's too late to try to read it now, Watson. The game is on!"
	RTRUE
?L4:	PRINTR "It isn't open, and there's only a picture of a rotten hand on the cover."

	.FUNCT ZIL-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "It's your father's 1977 ZIL-114, with a 6,959 cc V8 engine, the three-speed automatic transmission, and a big bumper sticker that reads 'VEHBIT.' He had it imported from Russia back in the nineties, but the VEHBIT kit was added recently."
...
?L27:	PUTB OUT,0,NOUT
	...
	EQUAL? BITS,F \?L70
	PRINTI "There is no 'all' available"
	EQUAL? PRSA,V?TAKE \?L72
	PRINTI " to take"
?L72:	EQUAL? PRSA,V?DROP \?L75
	PRINTI " to drop"
?L75:	PRINTI "!"
	CRLF
	RFALSE
?L70:	SET 'BITS,F
	SET 'OBITS,F
	JUMP ?L1
?L68:	EQUAL? NOUT,1 \?L79
	GET OUT,1 >STACK
	RSTACK
?L79:	EQUAL? MODE?1,MCM-ALL /?L81
	GRTR? NY,1 \?L80
?L81:	RETURN MANY-OBJECTS
?L80:	EQUAL? MODE?1,MCM-ANY \?L82
	RANDOM NOUT >STACK
	GET OUT,STACK >F
	PUT OUT,1,F
	PUTB OUT,0,1
	...
	CRLF
	RETURN F
?L82:	EQUAL? BITS,OBITS /?L84
	SET 'BITS,OBITS
	JUMP ?L1
?L84:	CALL2 APPLY-GENERIC-FCN,OUT >F
	ZERO? F /?L87
	PUT OUT,1,F
	PUTB OUT,0,1
	RETURN F
?L87:	ICALL2 WHICH-DO-YOU-MEAN,OUT
	EQUAL? NP,P-NP-DOBJ \?L90
	SET 'P-O-REASON,32768
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
?L90:	SET 'P-O-REASON,40960
	SET 'P-V-WORDN,0
	SET 'P-O-CONT,P-CONT
	RFALSE
