	...
	.WORD 0
	.WORD 0
	.INSERT ".\reach-out-test_freq"
	.INSERT ".\reach-out-test_data"

	.FUNCT GO
START::
	SET 'MODE,VERBOSE
	MOVE PLAYER,JAIL-CELL
	SET 'HERE,PLACEHOLDER-ROOM
	CRLF
	CRLF
	PRINTI "INTRO TEXT GOES HERE"
	CRLF
	CRLF
	ICALL1 V-VERSION
	CRLF
...
?L1:	CRLF
	...
	.FUNCT JAIL-CELL-R,RARG
	EQUAL? RARG,M-FLASH \?L1
	PRINTI "MFLASH!"
	CRLF
?L1:	EQUAL? PRSA,V?ENTER \FALSE
	SET 'VEHICLE,JAIL-CELL
	RETURN VEHICLE

	.FUNCT V-TAKE
	PRINTI "V-TAKE"
	CRLF
	CALL2 ACCESSIBLE?,PRSO >STACK
	ZERO? STACK \?L1
	...
	CRLF
	RFALSE
?L1:	ICALL2 TRY-TAKE,PRSO
	RTRUE

	.FUNCT VISIBLE?,OBJ,P,M,PL
	PRINTI "VISIBLE?"
	CRLF
...
?L1:	LOC OBJ >P
	...
	PRINTI "IN SOMETHING"
	CRLF
	FSET? PL,TRANSBIT /?L13
	FSET? PL,OPENBIT /?L13
	FSET? PL,SURFACEBIT \?L11
?L13:	EQUAL? M,PL /TRUE
?L11:	EQUAL? P,LOCAL-GLOBALS \?L16
	CALL GLOBAL-IN?,OBJ,HERE >STACK
	ZERO? STACK \TRUE
?L16:	EQUAL? P,GLOBAL-OBJECTS,GENERIC-OBJECTS \FALSE
	RTRUE
?L17:	EQUAL? P,HERE,WINNER /TRUE
	CALL2 SEE-INSIDE?,P >STACK
	ZERO? STACK /FALSE
	LOC P >P
	JUMP ?L17

	.FUNCT ACCESSIBLE?,OBJ,L,PL
	PRINTI "ACCESSIBLE?"
	CRLF
	PRINTI "OBJ: "
	ICALL2 PRINT-DEF,OBJ
	...
	LOC WINNER >PL
	ZERO? PL /?L1
	FSET? PL,SURFACEBIT /?L1
	FSET? PL,CONTBIT \?L3
	FSET? PL,OPENBIT /?L1
?L3:	PRINTI "DEBUG: Can't reach outside container"
	CRLF
	RFALSE
?L1:	FSET? L,CONTBIT \?L7
	FSET? L,OPENBIT /?L7
	FSET? L,SURFACEBIT \FALSE
?L7:	EQUAL? L,HERE,WINNER /TRUE
	LOC L >L
	JUMP ?L1

	.INSERT ".\reach-out-test_str"
	.END
