...
?L10:	FSET? PRSI,PERSONBIT /?L11
	CALL2 NOT-POSSIBLE,STR?21 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 NOT-POSSIBLE,STR?27 >STACK
	RSTACK
...
?L1:	FSET? PRSO,PERSONBIT \?L3
	CALL1 YOU-MASHER >STACK
	RSTACK
?L3:	CALL2 POINTLESS,STR?28 >STACK
	RSTACK
...
?L1:	GETPT HERE,PRSO >PT
	...
	ZERO? STACK \?L4
?L6:	PRINTI "YOU CAN'T GO THAT WAY!!!!!!"
	CRLF
?L4:	SET 'P-CONT,0
	RTRUE
?L3:	PTSIZE PT >PTS
