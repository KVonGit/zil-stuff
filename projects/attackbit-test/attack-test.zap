	.INSERT ".\attack-test_freq"
	.INSERT ".\attack-test_data"
...
?L85:	CALL STARTS-NOUN-PHRASE?,W >STACK
	...
	SET 'DIR,0
	SET 'DIR-WN,0
?L93:	CALL PARSE-NOUN-PHRASE,I,P-NP-DOBJ >VAL
	JUMP ?L97
?L91:	EQUAL? NOBJ,2 \?L96
...
?L117:	SET 'P-CONT,0
	RFALSE
?L113:	LESS? KEEP,2 \?L120
	CALL FIND-OBJECTS,KEEP >STACK
	ZERO? STACK \?L120
	SET 'P-CONT,0
	RFALSE
?L120:	EQUAL? PRSA,V?AGAIN /?L124
	CALL SAVE-PARSER-RESULT,AGAIN-STORAGE
?L124:	CALL SET-PRONOUNS,PRSO,P-PRSOS
	RTRUE
...
?L17:	ADD RBUF,S >STACK
	CALL COPY-TABLE-B,TEMPTABLE+2,STACK,NL
	RTRUE
...
?L1:	GETB SRC,I >STACK
	...
	.FUNCT PARSE-NOUN-PHRASE,WN,NP,SILENT?=0,SPEC,CNT,W,VAL,MODE?1,ADJ,NOUN,BUT,SPEC-WN,NW
	GET NP,1 >SPEC
	PUTB NP,1,0
?L1:	GRTR? WN,P-LEN /?L2
	CALL GETWORD?,WN >W
...
?L8:	CALL RTN >STACK
	...
	.FUNCT GOTO,RM,WAS-LIT,F,OWINNER=0
...
?L1:	SET 'WAS-LIT,HERE-LIT
	...
	JUMP ?L12
?L6:	CALL DARKNESS-F,M-DARK-TO-DARK >STACK
	ZERO? STACK \?L9
...
?L3:	USL
	...
	CRLF
?L2:	PRINTI "Would you like to RESTART, RESTORE or QUIT? > "
?L5:	CALL READLINE
	GETB LEXBUF,1 >STACK
	ZERO? STACK \?L8
	SET 'W,0
...
?L9:	EQUAL? W,W?RESTORE \?L11
	RESTORE /?L12
?L12:	PRINTI "Restore failed."
	CRLF
	JUMP ?L2
?L11:	EQUAL? W,W?QUIT \?L13
	CRLF
	PRINTI "Thanks for playing."
	CRLF
	QUIT
?L13:	EQUAL? W,W?UNDO \?L14
	CALL V-UNDO
	PRINTI "Undo failed."
	CRLF
	JUMP ?L2
...
?L1:	CALL SAVE-PARSER-RESULT,TEMP-PARSER-RESULT
...
?L6:	ZERO? PRSI /?L9
	...
	ZERO? STACK /?L5
?L9:	CALL PERFORM,PRSA,PRSO,PRSI
