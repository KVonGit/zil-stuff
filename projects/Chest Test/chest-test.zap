	...
	.WORD 0
	.WORD 0
	.INSERT ".\chest-test_freq"
	.INSERT ".\chest-test_data"
...
?L1:	CRLF
	...
	.FUNCT TESTING-CENTER-R
	EQUAL? PRSA,V?YES \?L1
	PRINTR "You sound very positive!"
?L1:	EQUAL? PRSA,V?NO \FALSE
	PRINTR "You sound rather negative."

	.FUNCT CHEST-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTI "It's just a chest, with no lock. It is currently "
	FSET? CHEST,OPENBIT \?L3
	PRINTI "open"
	JUMP ?L5
?L3:	PRINTI "closed"
?L5:	PRINTR "."
?L1:	EQUAL? PRSA,V?TAKE \?L6
	PRINTR ""
?L6:	EQUAL? PRSA,V?UNLOCK,V?LOCK \FALSE
	PRINTR "It has no lock, and you have no key."

	.FUNCT NOTE-R
	EQUAL? PRSA,V?EXAMINE \FALSE
	PRINTR "About what you'd expect, it's made of paper and has words written on it."

	.FUNCT LOCK-R
	EQUAL? PRSA,V?EXAMINE \?L1
	PRINTR "The chest has no lock."
?L1:	EQUAL? PRSA,V?TAKE \?L3
	PRINTR "You can't take a lock that doesn't exist!"
?L3:	EQUAL? PRSA,V?OPEN,V?CLOSE \?L4
	PRINTR "There is no lock. (Are you sure you're old enough to play a text adventure?)"
?L4:	EQUAL? PRSA,V?LOCK,V?UNLOCK \FALSE
	PRINTR "You have no key, and there is no lock!"
...
?L3:	EQUAL? PRSA,V?DROP \FALSE
	PRINTR "You are already holding no key!"

	.INSERT ".\chest-test_str"
	.END
